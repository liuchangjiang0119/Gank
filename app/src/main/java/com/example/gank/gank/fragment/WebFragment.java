...
public class WebFragment extends Fragment implements GankMainContract.View{
...
//            mPresenter.loadArticle(GankMainPresenter.TYPE_WEB);
...
//        Log.d("Web","onresume");
    ...
    public void initRecyclerView(){
        mAdapter = new ArticleRecyclerViewAdapter(getActivity().getApplicationContext(),"WEB");
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE&&
                    ...
                    mPresenter.loadMoreArticle(GankMainPresenter.TYPE_WEB);
                }
