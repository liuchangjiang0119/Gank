...
public class AndroidFragment extends Fragment implements GankMainContract.View{
    ...
    public static AndroidFragment newInsance(){
...
//            mPresenter.loadArticle(GankMainPresenter.TYPE_ANDROID);
    ...
    public void initRecyclerView(){
        mAdapter = new ArticleRecyclerViewAdapter(getActivity().getApplicationContext(),GankMainPresenter.TYPE_ANDROID);
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE&&
                    ...
                    mPresenter.loadMoreArticle(GankMainPresenter.TYPE_ANDROID);
                }
